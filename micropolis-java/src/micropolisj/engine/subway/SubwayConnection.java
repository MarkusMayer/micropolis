...
public class SubwayConnection {
	...
	public SubwayConnection(SubwayStation station1, SubwayStation station2) {
		if (station1.equals(station2))
			throw new IllegalArgumentException("Cannot connect station to itself. Station1: "+station1+", Station2: "+station2);
	...
	public SubwayStation connectsTo(SubwayStation station) {
	...
	public int getLength() {
		return Math.abs(station1.getX()-station2.getX())+Math.abs(station1.getY()-station2.getY());
	}
